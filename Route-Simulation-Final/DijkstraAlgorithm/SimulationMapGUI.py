...
# BRGY 2 PASIG
        ...
        if i == 'GAHONONP3':
            ...
            GAHONONP3 = map_widget.set_marker(14.1196661, 122.9493706, text="Gahonon P-3")

            raw_coordinates.append([14.1196661, 122.9493706])

            raw_routes.append(GAHONONP3)

        if i == 'GAHONONP4':

            GAHONONP4 = map_widget.set_marker(14.1271937, 122.9599124, text="Gahonon P-4")

            raw_coordinates.append([14.1271937, 122.9599124])
...
def MainMenu():
    ...
    canvas = Canvas(root, width=1200, height=700, bg='orange')
    canvas.pack()

    my_label = LabelFrame(root)
    my_label.pack(pady=20, side=tk.BOTTOM)
    ...
    map_widget = tkintermapview.TkinterMapView(my_label, width=1200, height=600, corner_radius=0)
    #map_widget.set_position(14.0996, 122.9550)


    canvas.create_window(600, 300, window=my_label)
